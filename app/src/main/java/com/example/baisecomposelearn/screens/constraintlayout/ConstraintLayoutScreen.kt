...
fun ConstraintLayoutScreen(navController: NavController) {
   val modo: Modifier = Modifier
    ...
    ScreenModel(navController = navController, isGoBack = false, content = {
        ...
        Button(modifier = modo,
            onClick = { navController.navigate(NavitemScreen.CustomShapeScreen.route) }) {
            Text(
                text = stringResource(id = R.string.customshape),
                fontWeight = FontWeight.Bold,
                fontSize = 24.sp,
                color = Color.White
            )
        ...
        Button(modifier = modo,
            onClick = { navController.navigate(NavitemScreen.CustomCalendarView.route) }) {
            Text(
                text = stringResource(id = R.string.customcalendarview),
                fontWeight = FontWeight.Bold,
                fontSize = 24.sp,
                color = Color.White
            )
        ...
        Button(modifier = modo,
            onClick = { navController.navigate(NavitemScreen.MotionLayoutCompose.route) }) {
            Text(
                text = stringResource(id = R.string.motionlayoutcompose),
                fontWeight = FontWeight.Bold,
                fontSize = 24.sp,
                color = Color.White
            )
